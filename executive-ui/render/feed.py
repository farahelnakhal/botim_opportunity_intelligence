...
def render(model):
    ...
    note = ('<p class="lede">Change signals over the knowledge base and external sources. '
            ...
            '<strong>No impact-approval or rollback workflow exists in this system yet</strong> — '
            'items below are informational leads, monitoring alerts, and report-only signals.</p>')
